...
data=pd.read_csv(r'C:\Users\pavit\OneDrive\Documents\my folder\data science\Simple_Linear_Regression-main\Simple_Linear_Regression-main\Salesdata.csv')
data.columns
